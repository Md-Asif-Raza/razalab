        ...
        {tab === 'hero' && (
          <>
            ...
            <div className="cms-settings-card">
              ...
              <div className="form-row mb-16"><div className="form-group"><label className="form-label">Bottom Btn Text</label><input className="form-input" value={settingsData.cta_button_text} onChange={e => setSettingsData({ ...settingsData, cta_button_text: e.target.value })} /></div><div className="form-group"><label className="form-label">Bottom Btn Link</label><input className="form-input" value={settingsData.cta_button_link} onChange={e => setSettingsData({ ...settingsData, cta_button_link: e.target.value })} /></div></div>
              <h3 className="cms-settings-heading mt-32">🗺️ Navbar Navigation</h3>
              <div className="form-row mb-24"><div className="form-group"><label className="form-label">Navbar CTA Text (e.g. Book a Call)</label><input className="form-input" value={settingsData.navbar_cta_text || 'Book a Call'} onChange={e => setSettingsData({ ...settingsData, navbar_cta_text: e.target.value })} /></div><div className="form-group"><label className="form-label">Navbar CTA Link</label><input className="form-input" value={settingsData.navbar_cta_link || 'https://calendly.com/'} onChange={e => setSettingsData({ ...settingsData, navbar_cta_link: e.target.value })} /></div></div>
