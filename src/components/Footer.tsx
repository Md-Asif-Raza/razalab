    ...
    <>
      <footer>
        ...
        <div className="footer-socials">
          ...
          <a href={socials.youtube_url} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="YouTube">
          ...
          <a href={socials.twitter_url} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="X">
